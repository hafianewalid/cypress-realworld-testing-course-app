            ...
            <div className="pt-5 pb-6 px-5">
              ...
              <div className="relative bg-white pt-16 overflow-hidden">
                <div className="max-w-lg mx-auto">
                  <Link href="/real-world-examples" className="w-full bg-blue-600 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                      Real World Examples
                  </Link>
                </div>
              </div>
